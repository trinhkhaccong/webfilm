...
if __name__ == "__main__":
    lines_phim_le=[]
    with open("phim-sap-chieu","r",encoding="utf8") as tf:
        lines_phim_le= tf.readlines()
    with open("phim-sap-chieu-backup","r+",encoding="utf8") as tf1:
    ...
    for link in lines_phim_le:
        ...
        insert = ("INSERT INTO tb_filmintro (year, director, cast, content, link,link_background,name,id_typephim,id_quocgia,time) VALUES (%s, %s, %s, %s, %s,%s, %s, %s, %s, %s)")
        data = (_year,_director, _cast, _content, _link,_link_background,_name,_id_typephim,_id_quocgia,_time,)
        ...
        with open("phim-sap-chieu-backup","a+",encoding="utf8") as tf2:
            tf2.write(link)
        time.sleep(2)